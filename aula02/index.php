...
<p style="padding: 5px;background-color:#f5f5f5;border-radius:10px;color:blue;line-height:20px;font-size:16px;">
   ...
   ?>
    <hr>
    <p style="padding: 5px;background-color:#f5f5f5;border-radius:10px;color:blue;line-height:20px;font-size:16px;">
Crie um loop que exiba os números pares que temos até 10 utilizando a estrutura for (incremento) 
sem criar condicoes. <br>
    </p>
<?php
     /* o for é um método de estrutura de repeticao, que recebe tres parametros:
     onde o primeiro é o critério de início da nossa variável contadora, ou seja,
...
<p>Loops - Do While</p>
<p style="padding: 5px;background-color:#f5f5f5;border-radius:10px;color:blue;line-height:20px;font-size:16px;">
      Crie um loop que exiba os números de 1 a 10 utilizando do while (incremento)   
    </p>
. <br>

 <?php
     /* funciona de uma forma que primeiro indica ao codigo para executar as instrucões dentro do bloco
 ...
 Crie um loop que exiba os números de 10 a 1 utilizando do while (decremento). <br>
    ...
    <p style="padding: 5px;background-color:#74992e;border-radius:10px;color:blue;line-height:20px;font-size:16px;">
